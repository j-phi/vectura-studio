...
## Corpus Check
- 294 files · ~1,821,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2116 nodes · 4182 edges · 215 communities detected
...
Cohesion: 0.02
Nodes (62): buildControls(), fromVectura(), requireDeps(), App, getThemeBrightness(), getThemeConfig(), getThemeFamily(), getThemeIdForFamilySlot() (+54 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (117): create(), openColorModal(), requireDeps(), create(), normalizeHex(), trap(), loadNoiseImageFile(), openNoiseImageModal() (+109 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (88): clamp(), lerp(), centerProfile(), clipFanLine(), dampen(), displace(), envAtX(), getFanBottomX() (+80 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (90): documentUnitsToMm(), formatDocumentLength(), getDocumentUnitLabel(), getDocumentUnitPrecision(), getDocumentUnitStep(), mmToDocumentUnits(), normalizeDocumentUnits(), attachInfoButton() (+82 more)
...
Cohesion: 0.04
Nodes (91): xAt(), yAt(), buildSourceFillSampler(), choosePatternFillResolution(), clipSegmentToComposite(), collectBoundaryCrossings(), collectBoundaryEndpointCandidates(), collectCompiledPaths() (+83 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (59): getPreferredNewLayerType(), isDrawableLayerType(), isModifierType(), rememberDrawableLayerType(), requireDeps(), syncPrimaryModuleDropdown(), initBottomPaneResizer(), initBottomPaneToggle() (+51 more)
...
Cohesion: 0.05
Nodes (34): applyPad(), clamp01(), frac(), iterateSamples(), baseLayerShape(), combineBlend(), createEvaluator(), defaultConfigFor() (+26 more)
...
Cohesion: 0.29
Nodes (3): loadVecturaRuntime(), parseLocalScripts(), setupTwoShapeLayers()
...
- **Thin community `Community 66`** (2 nodes): `loadInJSDOM()`, `menubar-compile.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `clone()`, `petalis-noise-rack-modifiers.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 95`** (2 nodes): `loadInJSDOM()`, `info-modals-compile.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (2 nodes): `buildShell()`, `focus.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 99`** (2 nodes): `ensurePetalisLayer()`, `petal-designer-roundtrip.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (2 nodes): `clone()`, `export-determinism.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 103`** (2 nodes): `sameRow()`, `iphone-mini.spec.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `send()`, `dev-server.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `listFiles()`, `patch-vitest-unicode.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `layerSvg()`, `icons.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `buildFillControlDefs()`, `ui-fill-panel.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (2 nodes): `create()`, `tooltip.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (2 nodes): `create()`, `dialog.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (2 nodes): `create()`, `drag-drop.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `sort()` connect `Community 12` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 14`, `Community 15`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Renderer` connect `Community 0` to `Community 1`, `Community 2`, `Community 13`, `Community 15`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `addEventListener()` connect `Community 2` to `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 18`?**
