...
## Corpus Check
- 142 files · ~2,572,513 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2999 nodes · 7549 edges · 116 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 1289 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (122): App, getThemeConfig(), normalizeThemeName(), Vy(), usesManualSourceGeometry(), VectorEngine, buildSourceFillSampler(), parseNumber() (+114 more)
...
Cohesion: 0.02
Nodes (23): isModifierLayer(), round(), rect(), buildBoundsFromVertices(), buildEllipseAnchors(), buildLineAnchors(), buildPolygonVertices(), buildRectangleVertices() (+15 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (168): clamp(), lerp(), centerProfile(), clipFanLine(), dampen(), displace(), envAtX(), getFanBottomX() (+160 more)
...
Cohesion: 0.03
Nodes (91): bb, clone(), isValidDrawableLayerType(), buildEngine(), resolveDrawableLayerType(), B(), fmt(), pathsToSvg() (+83 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (92): xAt(), yAt(), buildEnvelope(), classifyEndpoint(), clone(), firstEndSegmentHits(), firstStartSegmentHits(), pointEquals() (+84 more)
...
Cohesion: 0.04
Nodes (18): ae, de(), _e(), fe(), gt, he, ke(), le (+10 more)
...
Cohesion: 0.04
Nodes (18): od(), qv, captureSvgExport(), expectAllCoordsInsideMargin(), text(), captureSvgExport(), createCirclePath(), createMaskedEngine() (+10 more)
...
- **Thin community `Community 59`** (2 nodes): `sourcePaths Reserved for Expanded Geometry Decision`, `Rationale: sourcePaths Reserved for Expanded Geometry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (2 nodes): `Flowfield Algorithm Canonical Baseline SVG`, `Flowfield Algorithm Gallery Sample SVG`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (2 nodes): `Wavetable Horizon 3D Canonical Baseline SVG`, `Wavetable Horizon Canonical Baseline SVG`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
