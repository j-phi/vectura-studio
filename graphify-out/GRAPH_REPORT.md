# Graph Report - /Users/jayphi/Documents/github/vectura-studio  (2026-05-25)

## Corpus Check
- 373 files · ~4,629,952 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4034 nodes · 9717 edges · 215 communities detected
...
Cohesion: 0.01
Nodes (351): ef(), ff(), Ja(), lf(), mt(), nf(), po(), Qa() (+343 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (341): bindAlgoConfigListeners(), buildControls(), fromVectura(), installOn(), requireDeps(), toggleSeedControls(), getBtn(), getIcon() (+333 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (42): setupLayer(), makeOpenPath(), setupLayer(), base(), rect(), sig(), recenterLayerIfNeeded(), buildScene() (+34 more)
...
Cohesion: 0.02
Nodes (133): applyScissor(), App, getThemeBrightness(), getThemeConfig(), getThemeFamily(), getThemeIdForFamilySlot(), normalizeThemeFamily(), normalizeThemeName() (+125 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (174): buildExportPreviewPath(), xAt(), yAt(), arcConfig(), bodyHtmlFor(), build(), closeAllPopovers(), defaultParamsFor() (+166 more)
...
Cohesion: 0.04
Nodes (103): clamp(), removeEventListener(), isPetalisLayerType(), applyAlgorithmBias(), applyLissajousBias(), applyPetalisBias(), applyRainfallBias(), applyShapePackBias() (+95 more)
...
Cohesion: 0.03
Nodes (28): goToNext(), goToPrevious(), makeCurrent(), toggleClass(), a0(), h0(), hs, lr (+20 more)
...
Cohesion: 0.1
Nodes (11): d_, eb(), f_, gc(), h_, i0(), od(), p_ (+3 more)
...
- **Thin community `Community 66`** (2 nodes): `cleanupTempSkin()`, `skin-sdk.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `sampleField()`, `phylla.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 69`** (2 nodes): `makeBareRenderer()`, `renderer-cursor-mode-and-mask-preview.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `buildLayer()`, `ui-bootstrap-panels.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 72`** (2 nodes): `pointsToAnchors()`, `anchor-rebuild.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `centroidAxisOrder()`, `engine-workflow.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `dragEvent()`, `modifier-workflow.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `create()`, `dialog.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 112`** (1 nodes): `_skin-shots.mjs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `pen-close-2-anchor.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 128`** (1 nodes): `engine_state.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `wallpaper-groups.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 167`** (1 nodes): `auto-colorize.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (1 nodes): `algorithm-switching.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 169`** (1 nodes): `expand-layer-cache-clear.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 170`** (1 nodes): `lasso-direct-select.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 174`** (1 nodes): `info-tooltip-wireup.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 175`** (1 nodes): `file-menu-export-gating.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (1 nodes): `empty-state-and-progress.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 177`** (1 nodes): `mask-shift-drag.spec.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 178`** (1 nodes): `stress.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 179`** (1 nodes): `vitest.setup.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 180`** (1 nodes): `extract-changelog.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 181`** (1 nodes): `sync-version.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 182`** (1 nodes): `main.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 183`** (1 nodes): `controls-registry.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 184`** (1 nodes): `utils.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `sort()` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 21`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `Renderer` connect `Community 2` to `Community 1`, `Community 4`, `Community 12`, `Community 16`, `Community 18`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `mt()` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 11`, `Community 13`, `Community 20`, `Community 21`, `Community 22`?**
