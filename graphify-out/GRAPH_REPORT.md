...
## Corpus Check
- 123 files · ~2,285,391 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1603 nodes · 3412 edges · 102 communities detected
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 521 edges (avg confidence: 0.81)
...
Cohesion: 0.03
Nodes (22): joinNearbyPaths(), rect(), buildBoundsFromVertices(), buildEllipseAnchors(), buildPolygonVertices(), buildRectangleVertices(), buildRoundedPolygonAnchors(), buildShapeAnchors() (+14 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (17): App, getThemeConfig(), normalizeThemeName(), createModifierState(), isModifierLayer(), buildMirroredMaskedSceneSvg(), formula(), generate() (+9 more)
...
Cohesion: 0.05
Nodes (83): listProfileFiles(), buildEnvelope(), classifyEndpoint(), firstEndSegmentHits(), firstStartSegmentHits(), pointEquals(), pointInPolygon(), segmentIntersection() (+75 more)
...
Cohesion: 0.05
Nodes (38): iterateSamples(), SimpleNoise, round(), choosePatternFillResolution(), CoordRounder, applyNoiseOffset(), applyTrailBreaks(), buildDropShape() (+30 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (32): isValidDrawableLayerType(), resolveDrawableLayerType(), usesManualSourceGeometry(), VectorEngine, clonePaths(), countPathPoints(), applyMaskToPaths(), buildClosedPathSilhouettes() (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (51): fmt(), pathsToSvg(), shapeToSvg(), buildClipPathMarkup(), buildPreviewPair(), buildRangeValue(), buildVariantsFromDef(), clamp() (+43 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (50): clamp01(), combineBlend(), createEvaluator(), applyDesignerProfileSymmetry(), applyLineType(), applyModifiers(), bboxFromPoints(), bboxIntersects() (+42 more)
...
Cohesion: 0.2
Nodes (16): centerProfile(), clamp01(), clipFanLine(), dampen(), displace(), envAtX(), getFanBottomX(), lerp() (+8 more)
...
- **Why does `sort()` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `Renderer` connect `Community 0` to `Community 1`, `Community 7`, `Community 15`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `UI` connect `Community 1` to `Community 8`, `Community 9`, `Community 6`, `Community 15`?**
