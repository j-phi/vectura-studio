...
| **Text** | Sets a string in a built-in single-line (monoline) stroke font — five selectable styles (Sans, Italic, Condensed, Wide, Backslant) — and fits it to the frame as pen-ready line art, with multi-line, alignment, letter spacing, line height, frame-fit or absolute mm sizing, manual offset, and an optional hand-drawn jitter |
