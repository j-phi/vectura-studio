...
- Mobile-first responsive shell for small phones (including iPhone mini): horizontal-scrolling action bar, top-docked tool rail, pane toggles with edge-tab affordances for Generator/Layers, and a floating Model toggle for the formula panel.
