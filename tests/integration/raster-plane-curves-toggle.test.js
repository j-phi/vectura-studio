...
/*
 * Raster-Plane — Curves toggle regenerates geometry (UI wiring RGR).
 *
 ...
 * flag) but inert for the 3D ones, so the Raster-Plane Curves toggle did
 * nothing. It must `regen()` for is3d layers.
 */
describe('Raster-Plane — Curves toggle regenerates geometry', () => {
  ...
  test('toggling Curves on an Raster-Plane regenerates baked bézier geometry', () => {
