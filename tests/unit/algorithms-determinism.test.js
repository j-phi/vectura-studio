...
const OVERRIDES = {
  ...
  spiralizer: { curveResolution: 160, lineCount: 8 },
  polyhedron: { faceBands: 2, showVertices: true },
  topoform: { primitiveDetail: 10, lineCount: 10 },
  rasterPlane: { sampleDetail: 24, rows: 10, columns: 10, barRows: 6, barColumns: 6 },
};
