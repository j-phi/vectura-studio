...
(() => {
  ...
  CONTROL_DEFS.imageSurface = [
    ...
    { id: 'normalFlipY', label: 'Flip Normal Y', type: 'checkbox' },
    { id: 'clipBlackAreas', label: 'Clip Black', type: 'checkbox' },
    { id: 'artworkSize', label: 'Artwork Size', type: 'range', min: 30, max: 260, step: 1, displayUnit: 'mm', livePreview: true },
    { id: 'amplitude', label: 'Amplitude', type: 'range', min: 0, max: 60, step: 0.5, displayUnit: 'mm', livePreview: true },
    { id: 'sampleDetail', label: 'Sample Detail', type: 'range', min: 12, max: 160, step: 1, livePreview: true },
    { id: 'smoothing', label: 'Image Smoothing', type: 'range', min: 0, max: 100, step: 1, livePreview: true },
    ...
    { id: 'seeThrough', label: 'See-Through', type: 'checkbox', showIf: (p) => p.mode === 'mesh' || p.mode === 'bars' },
    ...
    { id: 'contourSmoothing', label: 'Contour Smoothing', type: 'range', min: 0, max: 100, step: 1, showIf: (p) => p.mode === 'topography', livePreview: true },
    { id: 'barRows', label: 'Bar Rows', type: 'range', min: 1, max: 80, step: 1, showIf: (p) => p.mode === 'bars', livePreview: true },
    { id: 'barColumns', label: 'Bar Columns', type: 'range', min: 1, max: 80, step: 1, showIf: (p) => p.mode === 'bars', livePreview: true },
    { id: 'barGap', label: 'Bar Gap', type: 'range', min: 0, max: 0.8, step: 0.02, showIf: (p) => p.mode === 'bars', livePreview: true },
    { type: 'section', label: 'View' },
    { id: 'projection', label: 'Projection', type: 'select', options: [{ value: 'orthographic', label: 'Orthographic' }, { value: 'perspective', label: 'Perspective' }] },
    { id: 'cameraDistance', label: 'Camera Distance', type: 'range', min: 150, max: 2000, step: 10, showIf: (p) => p.projection === 'perspective', livePreview: true },
    { id: 'focalLength', label: 'Depth Strength', type: 'range', min: 100, max: 1500, step: 10, showIf: (p) => p.projection === 'perspective', livePreview: true },
