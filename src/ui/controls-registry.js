...
(() => {
  ...
  const CONTROL_DEFS = {
    ...
    halftone: [
      ...
      { id: 'gridAngle', label: 'Screen Angle', type: 'range', min: -90, max: 90, step: 1, displayUnit: '°' },
      {
        id: 'dotShape',
        label: 'Dot Shape',
        type: 'select',
      ...
      { id: 'dotSpin', label: 'Rotation', type: 'range', min: -180, max: 180, step: 1, displayUnit: '°' },
    ...
    imageWeave: [
      ...
      { id: 'lineAngle', label: 'Line Angle', type: 'range', min: -90, max: 90, step: 1, displayUnit: '°' },
  ...
  CONTROL_DEFS.rasterPlane = [
    ...
    { id: 'barRotate', label: 'Bar Rotate', type: 'range', min: -180, max: 180, step: 1, displayUnit: '°', showIf: (p) => p.mode === 'bars', livePreview: true },
