...
(() => {
  ...
  CONTROL_DEFS.spiral3d = [
    ...
    { id: 'baseRadius', label: 'Cone Radius', type: 'range', min: 10, max: 140, step: 1, displayUnit: 'mm', showIf: (p) => p.shape === 'cone', livePreview: true },
    { id: 'coneHeight', label: 'Cone Height', type: 'range', min: 20, max: 220, step: 1, displayUnit: 'mm', showIf: (p) => p.shape === 'cone', livePreview: true },
    { id: 'cylinderRadius', label: 'Cylinder Radius', type: 'range', min: 10, max: 140, step: 1, displayUnit: 'mm', showIf: (p) => p.shape === 'cylinder', livePreview: true },
    { id: 'cylinderHeight', label: 'Cylinder Height', type: 'range', min: 20, max: 240, step: 1, displayUnit: 'mm', showIf: (p) => p.shape === 'cylinder', livePreview: true },
    ...
    { id: 'capsuleRadius', label: 'Capsule Radius', type: 'range', min: 10, max: 120, step: 1, displayUnit: 'mm', showIf: (p) => p.shape === 'capsule', livePreview: true },
    { id: 'capsuleHeight', label: 'Capsule Height', type: 'range', min: 0, max: 220, step: 1, displayUnit: 'mm', showIf: (p) => p.shape === 'capsule', livePreview: true },
    {
      id: 'surfaceMode',
      label: 'Visibility',
      type: 'select',
    ...
    { id: 'turns', label: 'Turns', type: 'range', min: 1, max: 48, step: 0.5, showIf: (p) => p.wrapType !== 'twistedLines', livePreview: true },
    { id: 'twistTurns', label: 'Twist Turns', type: 'range', min: -24, max: 24, step: 0.1, showIf: (p) => p.wrapType === 'twistedLines', livePreview: true },
    { id: 'lineCount', label: 'Line Count', type: 'range', min: 1, max: 160, step: 1, showIf: (p) => p.wrapType === 'twistedLines', livePreview: true },
    { id: 'dotSpacing', label: 'Dot Spacing', type: 'range', min: 2, max: 30, step: 0.5, showIf: (p) => p.renderStyle === 'dots', livePreview: true },
    { id: 'dotSizeStart', label: 'Start Dot', type: 'range', min: 0.8, max: 12, step: 0.1, showIf: (p) => p.renderStyle === 'dots', livePreview: true },
    { id: 'dotSizeMiddle', label: 'Middle Dot', type: 'range', min: 0.8, max: 12, step: 0.1, showIf: (p) => p.renderStyle === 'dots', livePreview: true },
    { id: 'dotSizeEnd', label: 'End Dot', type: 'range', min: 0.8, max: 12, step: 0.1, showIf: (p) => p.renderStyle === 'dots', livePreview: true },
  ...
  CONTROL_DEFS.meshTopography = [
    ...
    { id: 'planeTilt', label: 'Plane Tilt', type: 'range', min: -90, max: 90, step: 1, displayUnit: '°', livePreview: true },
    {
      ...
      options: [
        ...
        { value: 'fullContour', label: 'Full / Dashed Hidden' },
      ],
    },
  ...
  CONTROL_DEFS.imageSurface = [
    ...
    { id: 'smoothing', label: 'Map Blur', type: 'range', min: 0, max: 100, step: 1, livePreview: true },
    ...
    { id: 'seeThrough', label: 'See-Through', type: 'checkbox', showIf: (p) => p.mode === 'mesh' || p.mode === 'topography' || p.mode === 'bars' || (p.mode === 'lines' && p.horizontalLinesAsPlanes) },
  ...
  const PRESET_CONTROL_SYSTEMS = [
    ...
    'spiral', 'shapePack', 'spirograph', 'spiral3d', 'polyhedron',
    'meshTopography', 'imageSurface',
  ];
