...
(() => {
  ...
  const layer = {
    ...
    maskSrcActive:  () => layerSvg(`<path fill-rule="evenodd" fill="currentColor" d="M2 3a1 1 0 0 0-1 1v2a2.5 2.5 0 0 0 2.5 2.5 4 4 0 0 1 2.5 1 4 4 0 0 1 2.5-1 2.5 2.5 0 0 0 2.5-2.5V4a1 1 0 0 0-1-1h-1.5a4 4 0 0 0-2.5 1 4 4 0 0 0-2.5-1zM1.4 5a2 1.4 0 1 0 4 0a2 1.4 0 1 0-4 0M6.6 5a2 1.4 0 1 0 4 0a2 1.4 0 1 0-4 0"/>`),
