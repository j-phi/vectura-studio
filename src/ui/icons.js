...
(() => {
  ...
  const layer = {
    ...
    spiral3d:     () => layerSvg(`<ellipse cx="6" cy="6" rx="4.3" ry="2.1"/><path d="M2.2 6c.8-3 2-4.5 3.8-4.5S9 3 9.8 6 8 10.5 6 10.5 3 9 2.2 6z"/><path d="M3 7.6c1.3-1.1 4.8-2.1 6-3.2"/>`),
    polyhedron:   () => layerSvg(`<path d="M6 1.5 10 3.8v4.4L6 10.5 2 8.2V3.8z"/><path d="M2 3.8 6 6l4-2.2"/><path d="M6 6v4.5"/>`),
    meshTopography: () => layerSvg(`<path d="M1.5 8.8 4 4.3l3 4.2 2-3.3 1.5 3.6"/><path d="M2.2 9.7h7.6M3.2 7.2h5.6M4.4 5.1h3.5"/><path d="M4 4.3 9 5.2M7 8.5 4 4.3"/>`),
    imageSurface: () => layerSvg(`<rect x="1.5" y="2" width="9" height="8" rx=".8"/><path d="M3 7.8c1.2-2.4 2.2-2.4 3 0s2 2.4 3 0"/><path d="M3.2 4.2h5.6M4 2v8M8 2v8" opacity=".75"/>`),
