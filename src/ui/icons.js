...
(() => {
  ...
  const cursor = {
    ...
    // Illustrator-style rotation cursors: quarter-arc with two perpendicular
    // arrowheads at each end pointing radially outward. NE is the canonical
    // shape; SE/SW/NW are 90°/180°/270° clockwise rotations of the same art.
    // Halo (white) is drawn first for legibility on light/dark canvases.
    'rotate-ne': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="8,1 5,4 11,4" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/><polygon points="15,8 12,5 12,11" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/></svg>`,
    'rotate-se': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><g transform="rotate(90 8 8)"><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="8,1 5,4 11,4" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/><polygon points="15,8 12,5 12,11" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/></g></svg>`,
    'rotate-sw': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><g transform="rotate(180 8 8)"><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="8,1 5,4 11,4" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/><polygon points="15,8 12,5 12,11" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/></g></svg>`,
    'rotate-nw': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><g transform="rotate(270 8 8)"><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M8 4 A 4 4 0 0 1 12 8" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="8,1 5,4 11,4" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/><polygon points="15,8 12,5 12,11" fill="#000000" stroke="#ffffff" stroke-width="0.8" stroke-linejoin="round"/></g></svg>`,
  };
