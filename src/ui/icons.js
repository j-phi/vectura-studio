...
(() => {
  ...
  const layer = {
    ...
    boids:        () => layerSvg(`<path d="M6 2l1.5 3.5L11 6l-3.5 1.5L6 11l-1.5-3.5L1 6l3.5-1.5Z"/>`),
    ...
    harmonograph: () => layerSvg(`<path d="M1 6c1-3 2-4 3-3s1 3 2 3 2-2 3-3 2 1 2 3"/>`),
  ...
  const tool = {
    ...
    scissor:         () => '<circle cx="6.5" cy="7.5" r="2.6" fill="none" stroke="currentColor" stroke-width="1.6" /><circle cx="6.5" cy="16.5" r="2.6" fill="none" stroke="currentColor" stroke-width="1.6" /><path d="M8.6 9.2L20 4.5M8.6 14.8L20 19.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" /><path d="M11.5 12L15 10.5M11.5 12L15 13.5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />',
    'scissor-line':  () => '<path d="M5 20L6 17L19 4L22 7L9 20Z" fill="currentColor"/><line x1="5" y1="20" x2="3" y2="22" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>',
    'scissor-rect':  () => '<rect x="9" y="9" width="13" height="13" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.6"/><circle cx="4" cy="3" r="1.8" fill="none" stroke="currentColor" stroke-width="1.4"/><circle cx="4" cy="7.5" r="1.8" fill="none" stroke="currentColor" stroke-width="1.4"/><line x1="5.7" y1="4" x2="9.5" y2="9.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><line x1="5.7" y1="6.5" x2="9.5" y2="9.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>',
    'scissor-circle':() => '<circle cx="16" cy="16" r="7" fill="none" stroke="currentColor" stroke-width="1.6"/><circle cx="4" cy="3" r="1.8" fill="none" stroke="currentColor" stroke-width="1.4"/><circle cx="4" cy="7.5" r="1.8" fill="none" stroke="currentColor" stroke-width="1.4"/><line x1="5.7" y1="4" x2="10.5" y2="10.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><line x1="5.7" y1="6.5" x2="10.5" y2="10.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>',
