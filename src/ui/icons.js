...
(() => {
  ...
  const cursor = {
    ...
    'rotate-ne': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M2,14 A12,12 0 0 1 14,2" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M2,14 A12,12 0 0 1 14,2" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="14,2 11,5 15,5" fill="#000000" stroke="#ffffff" stroke-width="1" stroke-linejoin="round"/></svg>`,
    'rotate-se': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M2,2 A12,12 0 0 1 14,14" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M2,2 A12,12 0 0 1 14,14" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="14,14 11,11 11,15" fill="#000000" stroke="#ffffff" stroke-width="1" stroke-linejoin="round"/></svg>`,
    'rotate-sw': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M14,2 A12,12 0 0 1 2,14" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M14,2 A12,12 0 0 1 2,14" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="2,14 1,11 4,11" fill="#000000" stroke="#ffffff" stroke-width="1" stroke-linejoin="round"/></svg>`,
    'rotate-nw': () => `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M14,14 A12,12 0 0 1 2,2" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/><path d="M14,14 A12,12 0 0 1 2,2" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round"/><polygon points="2,2 5,1 5,4" fill="#000000" stroke="#ffffff" stroke-width="1" stroke-linejoin="round"/></svg>`,
  };
