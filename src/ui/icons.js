...
(() => {
  ...
  const cursor = {
    ...
    // Illustrator-style rotation cursors: a half-circle curve with arrowheads
    // at both ends pointing radially OUTWARD from the arc center. NE is the
    // canonical shape; SE/SW/NW are 90°/180°/270° clockwise rotations of it.
    // White halo is drawn first so the cursor stays legible on light/dark canvases.
    'rotate-ne': () => `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#ffffff" stroke-width="3.6" stroke-linecap="round"/><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#000000" stroke-width="1.8" stroke-linecap="round"/><polygon points="0.5,12 5.5,7 5.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/><polygon points="23.5,12 18.5,7 18.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/></svg>`,
    'rotate-se': () => `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g transform="rotate(90 12 12)"><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#ffffff" stroke-width="3.6" stroke-linecap="round"/><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#000000" stroke-width="1.8" stroke-linecap="round"/><polygon points="0.5,12 5.5,7 5.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/><polygon points="23.5,12 18.5,7 18.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/></g></svg>`,
    'rotate-sw': () => `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g transform="rotate(180 12 12)"><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#ffffff" stroke-width="3.6" stroke-linecap="round"/><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#000000" stroke-width="1.8" stroke-linecap="round"/><polygon points="0.5,12 5.5,7 5.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/><polygon points="23.5,12 18.5,7 18.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/></g></svg>`,
    'rotate-nw': () => `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g transform="rotate(270 12 12)"><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#ffffff" stroke-width="3.6" stroke-linecap="round"/><path d="M5.5 12 A 6.5 6.5 0 0 1 18.5 12" fill="none" stroke="#000000" stroke-width="1.8" stroke-linecap="round"/><polygon points="0.5,12 5.5,7 5.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/><polygon points="23.5,12 18.5,7 18.5,17" fill="#000000" stroke="#ffffff" stroke-width="1.4" stroke-linejoin="round"/></g></svg>`,
  };
