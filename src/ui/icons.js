...
(() => {
  ...
  const tool = {
    ...
    'select-rect':   () => '<rect x="4" y="6" width="16" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="2" stroke-dasharray="3 3" />',
    'select-oval':   () => '<ellipse cx="12" cy="12" rx="7" ry="5.5" fill="none" stroke="currentColor" stroke-width="2" stroke-dasharray="3 3" />',
    ...
    'scissor-line':  () => '<line x1="4" y1="20" x2="20" y2="4" stroke="currentColor" stroke-width="2" stroke-linecap="round" />',
    'scissor-rect':  () => '<rect x="4" y="6" width="16" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="2" />',
    'scissor-circle':() => '<circle cx="12" cy="12" r="7" fill="none" stroke="currentColor" stroke-width="2" />',
