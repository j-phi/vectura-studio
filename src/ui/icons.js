...
(() => {
  ...
  const layer = {
    ...
    spirograph:   () => layerSvg(`<path d="M6 6c1.8-3.1 5-2.2 4.3.5S6.8 9.7 4.9 8.5 2.7 4.5 5.2 3.7 8.4 5.3 7.5 7.4"/><circle cx="6" cy="6" r=".7" fill="currentColor" stroke="none"/>`),
    spiralizer: () => layerSvg(`<path d="M2.2 2.8C2.2 1.5 9.8 2.1 9.8 3.4 9.8 4.7 2.2 4.1 2.2 5.4 2.2 6.7 9.8 6.1 9.8 7.4 9.8 8.7 2.2 8.1 2.2 9.4"/>`),
    polyhedron:   () => layerSvg(`<path d="M6 1.5 10 3.8v4.4L6 10.5 2 8.2V3.8z"/><path d="M2 3.8 6 6l4-2.2"/><path d="M6 6v4.5"/>`),
    topoform: () => `<svg width="12" height="12" viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="11.25" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="m94.984 48.961c-0.089844-4.5586-0.90625-9.0938-2.5742-13.359-4.418-9.125-11.289-17.262-20.363-22.004-8.2422-4.5938-18.82-5.707-28.344-4.875-0.57422-0.078125-1.2617 0.046875-1.7461 0.17188-0.56641 0.0625-1.1289 0.13281-1.6836 0.21094-14.094 1.8516-25.887 12.414-32.152 24.816-5.8555 11.5-3.043 26.84 3.875 37.301-0.12109 0.24219-0.13281 0.54297 0.011718 0.78125 0.5625 0.91016 1.1914 1.7734 1.8398 2.6289 3.0742 4.168 7.0547 7.5508 11.414 10.328 3.4453 1.6758 6.9062 3.3672 10.645 4.2852 5.3672 1.6484 10.98 2.4961 16.602 2.2578 19.027-0.51172 37-12.406 41.344-31.547 0.72656-3.2188 1.1172-6.5273 1.1406-9.832 0.070312-0.41016 0.089843-0.82031-0.003907-1.1562zm-39.043-38.25c0.039063 0.039062 0.066406 0.078124 0.11328 0.11719 1.668 1.043 3.2305 2.1641 4.6484 3.5586 0.31641 0.27344 0.81641 0.24609 1.0938-0.074219 0.64453-0.67188-0.66406-1.9258-2.1055-3.0195 7.1562 1.418 13.66 4.4688 19.773 9.9883 3.0273 2.6328 5.4961 5.8789 7.6953 9.2227 1.9844 3.0703 3.875 6.2617 4.5547 9.9023 0.83594 3.375 1.2031 6.8672 1.1172 10.352-0.66797 1.3711-1.793 2.5195-3.0469 3.4141-3.3359 2.3086-6.8047 4.3906-10.805 5.3438-5.5352 1.4023-11.281 2.3398-16.973 2.9414-10.926 0.83594-21.957 0.0625-32.805-1.3633-0.625-0.089844-1.25-0.19922-1.8789-0.32422-2.6758-13.82-0.51172-28.738 6.0352-41.098 2.3672-3.9375 5.6016-8.2227 10.34-9.1875 0.69141-0.0625 1.3906-0.11719 2.0977-0.15234 3.5312-0.11719 6.9023-0.007812 10.141 0.375zm-38.57 13.246c5.8555-6.4258 12.234-10.488 19.934-12.398-1.7969 1.4961-3.3398 3.3438-4.6406 5.2344-4.8789 7.0156-7.0781 15.609-8.0508 24.016-0.82031 6.4
.72266 5.8086 0.23828 0.77344 1.4375 0.67188 1.5664-0.11719 0.0625-0.99609-0.03125-2.0586-0.16797-3.1172 1.5938 0.34766 3.1953 0.66406 4.7734 1.082 0.43359 0.085937 0.87109-0.25391 0.9375-0.6875 0.11719-0.96875-1.0703-1.0352-1.7422-1.2461-1.3867-0.38281-2.8047-0.61328-4.2109-0.92188h-0.011719c-0.046875-0.28516-0.089844-0.57422-0.13281-0.85547-0.19141-1.4102-1.7969-1.4805-1.7344 0.058594z"/></svg>`,
    rasterPlane: () => layerSvg(`<rect x="1.5" y="2" width="9" height="8" rx=".8"/><path d="M3 7.8c1.2-2.4 2.2-2.4 3 0s2 2.4 3 0"/><path d="M3.2 4.2h5.6M4 2v8M8 2v8" opacity=".75"/>`),
    // Scene-tree Increment C — 3D scene tree kinds.
  ...
  const tool = {
    select:          () => '<path d="M4.037 4.688a.495.495 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>',
    ...
    direct:          () => '<path d="M4.037 4.688a.495.495 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z" fill="currentColor" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>',
    type:            () => '<path d="M5 5h14M12 5v14M9.5 19h5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  const paintBucket = {
    ...
    // ── Canonical FILL_TYPE_OPTIONS keys (some are aliases to legacy entries) ──

    // wave: a single smooth sine wave through the middle (2.5 cycles).
    // Distinct from `wavelines` (two stacked) and `zigzag` (angular).
    ...
    // Top-left: arc top→left; Top-right: arc top→right; Bottom-left: arc
    // bottom→right; Bottom-right: arc bottom→left.
    truchet:    () => pbSvg(PB_FRAME +
      '<path d="M8.5 5 A3.5 3.5 0 0 0 5 8.5"/>' +
      '<path d="M11.5 5 A3.5 3.5 0 0 1 15 8.5"/>' +
      '<path d="M5 12.5 A3.5 3.5 0 0 0 8.5 16"/>' +
      '<path d="M15 12.5 A3.5 3.5 0 0 1 11.5 16"/>'
    ),

    // maze: 3x3 grid of cells with most internal walls present, a couple
    // removed to suggest a winding passage.
    maze:       () => pbSvg(PB_FRAME +
      '<line x1="4"  y1="4"  x2="18" y2="4"/>' +
      '<line x1="4"  y1="18" x2="18" y2="18"/>' +
      '<line x1="4"  y1="4"  x2="4"  y2="18"/>' +
      '<line x1="18" y1="4"  x2="18" y2="18"/>' +
      // interior walls (with gaps for corridors)
    ...
    stripes:    () => pbSvg(PB_FRAME +
      ...
      '<rect x="10" y="4" width="3" height="14" fill="currentColor" stroke="none" opacity="0.85"/>' +
      '<rect x="7"  y="4" width="3" height="14" fill="none"/>' +
    ...
    weave:      () => pbSvg(PB_FRAME +
      // vertical strands (drawn first, partially occluded by H at over-points)
      ...
      // horizontal strands (with gaps where vertical passes over)
