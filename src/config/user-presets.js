(() => {
  ...
  Vectura.PRESETS.push(...[
      ...
      {
        "id": "rasterplane-default",
        "name": "Default",
        "preset_system": "rasterPlane",
        "group": "Classic",
        "params": {
          "noises": [
            {
      ...
      },
      {
        ...
        "params": {
          ...
          "is3d": false,
          "category": "Image",
          "preset": "halftone-diamond-screen",
      ...
      {
        "id": "user-rasterPlane-1783460555721",
        "name": "Crater",
        "preset_system": "rasterPlane",
        "group": "Organic",
        "params": {
      ...
      },
      {
        ...
        "params": {
          "label": "Raster-Plane",
          "is3d": true,
          "preset": "rasterplane-relief-bars",
          "mode": "bars",
          "imageSourceKind": "builtin",
          "imageName": "Built-in Relief",
          "imageNoiseDef": null,
      ...
      {
        "id": "user-rasterPlane-1783459964410",
        "name": "River View",
        "preset_system": "rasterPlane",
        "group": "Organic",
        "params": {
      ...
      {
        "id": "user-rasterPlane-1783460302484",
        "name": "Subtle Dunes",
        "preset_system": "rasterPlane",
        "group": "Organic",
        "params": {
          "label": "Raster-Plane",
          "is3d": true,
          "preset": "user-rasterPlane-1783459964410",
          "mode": "mesh",
          "imageSourceKind": "noise",
          "imageName": "Dunes",
          "imageNoiseDef": {
      ...
      {
        "id": "user-rings-1786211570394",
        "name": "Cybersigil",
        "preset_system": "rings",
        "group": "Geometric",
        "params": {
          "label": "Rings",
          "preset": "user-rings-1786211407677",
          "rings": 29,
          "centerDiameter": 0,
          "outerDiameter": 140,
          "noises": [
      ...
      {
        "id": "user-rings-1786211407677",
        "name": "No-Moon",
        "preset_system": "rings",
        "group": "Geometric",
        "params": {
          "label": "Rings",
          "preset": "user-rings-1786211374368",
          "rings": 40,
          "centerDiameter": 0,
          "outerDiameter": 140,
          "noises": [
      ...
      {
        "id": "user-spiralizer-1781471356099",
        "name": "Helix",
        "preset_system": "spiralizer",
        "group": "Organic",
        "params": {
      ...
      {
        "id": "user-spiralizer-1781359265086",
        "name": "Simple Sphere",
        "preset_system": "spiralizer",
        "group": "Classic",
        "params": {
          "label": "Spiralizer",
          "is3d": true,
          "preset": "spiralizer-spherical-wrap",
          "shape": "sphere",
          "sphereRadius": 52,
          "baseRadius": 68,
          "coneHeight": 136,
      ...
      {
        "id": "user-spiralizer-1781359333969",
        "name": "Spherical Wrap",
        "preset_system": "spiralizer",
        "group": "Classic",
        "params": {
          "label": "Spiralizer",
          "is3d": true,
          "preset": "user-spiralizer-1781359265086",
          "shape": "sphere",
          "sphereRadius": 62,
          "baseRadius": 68,
          "coneHeight": 136,
      ...
      },
      {
        ...
        "params": {
          "label": "Spiralizer",
          "is3d": true,
          "preset": "spiralizer-twisted-cone",
          "shape": "cone",
          "sphereRadius": 64,
          "baseRadius": 57,
          "coneHeight": 142,
      ...
      },
      {
        ...
        "params": {
          "label": "Terrain",
          "is3d": true,
          "preset": "user-terrain-1781475148727",
          "perspectiveMode": "free-3d",
          "horizonHeight": 55,
          "vanishingPointX": 50,
          "vpLeftX": 20,
      ...
      },
      {
        ...
        "params": {
          "label": "Topoform",
          "is3d": true,
          "preset": "topoform-torus-contours",
          "sourceMode": "torus",
          "importedMesh": null,
          "meshName": "",
          "renderMode": "contours",
      ...
      {
        "id": "user-wavetable-1785695916421",
        "name": "Chain Link",
        "preset_system": "wavetable",
        "group": "Geometric",
        "params": {
          "preset": "user-wavetable-1785695784122",
          "lineStructure": "lattice",
          "lines": 66,
          "noiseType": "simplex",
          "noiseImageId": "",
          "noiseImageName": "",
          ...
          "edgeFadeMode": "left",
          "edgeFade": 34,
          "edgeFadeThreshold": 85,
          "edgeFadeFeather": 39,
          "noiseAngle": 0,
          "verticalFade": 50,
          "verticalFadeThreshold": 41,
          "verticalFadeFeather": 82,
          "verticalFadeMode": "bottom",
          "smoothing": 0.7000000000000001,
          "simplify": 0.7000000000000001,
          "curves": false
        }
      },
      {
