...
(() => {
  ...
  window.Vectura.DESCRIPTIONS = {
    ...
    wavetable:
      'Generates terrain-like elevations by modulating selectable line structures with one or more stacked noise sources. Inspired by the visualization of pulsar radio waves.',
    rings:
